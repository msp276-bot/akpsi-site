...
const REST = [
  "Omicron Tau has 50+ active members and an expansive 300+ alumni network, with 250,000+ AKPsi brothers worldwide as the oldest and largest business fraternity. Our current brothers are a microcosm of the success that Alpha Kappa Psi as a whole has achieved, securing internship and full-time roles at Sanofi, Accenture, Bristol Myers Squibb, Oracle, bp, Johnson & Johnson, BlackRock, and many others. As a new organization, we prioritize mentorship and brothers who are willing to help one another succeed, making it so that our members have exclusive access to career advancement opportunities through 1-1's with older brothers and alumni, networking events, and professional development workshops.",
