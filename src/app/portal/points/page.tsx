...
import { Upload, X, Clock, CheckCircle2, XCircle } from "lucide-react";
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      await createSubmission({
        ...
        pointsValue: selectedEvent.pointsValue,
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-muted">
          Submit chapter-event points and track approvals.
        </p>
      </div>
      ...
      <form onSubmit={onSubmit} className="rounded-2xl border border-line bg-white p-6">
        <h2 className="text-lg font-bold text-navy">Submit event points</h2>
